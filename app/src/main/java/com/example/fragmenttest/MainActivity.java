...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = findViewById(R.id.bt_FragmentStatic);
        ...
        Button button1 = findViewById(R.id.bt_FragmentDynamic);
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, BlankDynamicActivity.class);
                startActivity(intent);
            }
        });
        Button btBottom = findViewById(R.id.fm_to_bottom);
        btBottom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, FragmentBottomActivity.class);
                startActivity(intent);
            }
        });
        Button btViewPage = findViewById(R.id.bt_viewPage);
        btViewPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
